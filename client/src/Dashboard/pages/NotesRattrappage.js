...
import NotesRatComp from "../components/NotesRatComp";

const NotesRattrappage = () => {
    ...
    <div className="container">
      ...
      <Card>
        <Form.Group controlId="formFile" className="mb-3">
          <Form.Label>
            Selectionné le fichier Excel contenant les Notes du Session Rattrappage:
...
export default NotesRattrappage;
